...
# ==========================================
# 4. STICKY BULAN SABIT BERPIJAR & SPOTIFY AUDIO ENGINE (TRANSPARENT & REAL-PLAY)
# ==========================================
audio_floating_html = """
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* BULAN SABIT BERPIJAR MENYATU TANPA KOTAK KAKU */
        .moon-btn {
        ...
        /* CAHAYA BERPIJAR RADIANT MEMBASAHI AREA SEKITARNYA */
        .moon-btn.active {
            background: radial-gradient(circle, #fffbeb 0%, #fef08a 40%, #d97706 100%);
            border-color: #ffffff;
            box-shadow: 0 0 25px #fef08a, 0 0 60px rgba(254, 240, 138, 0.9), 0 0 120px rgba(245, 158, 11, 0.7);
        ...
        /* MINI SPOTIFY CONTROLLER DRAWER */
        .spotify-card {
...
<body>
    <div class="moon-player-container">
        ...
        <div class="spotify-card" id="spotify-drawer">
            <div>
                ...
                <div class="song-artist" id="artist-name">Ungu - Special Ruang Teduh Session</div>
            </div>
    ...
    <!-- AUDIO STREAM RELIABEL DENGAN REAL-TIME AUDIO CONTROLLER -->
